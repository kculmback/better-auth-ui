...
function DrawerContent({
  ...
  return /* @__PURE__ */ jsxs3(DrawerPortal, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ jsx8(DrawerOverlay, {}),
    /* @__PURE__ */ jsxs3(
      DrawerPrimitive.Content,
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsx8("div", { className: "bg-muted mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" }),
          children
        ]
      }
    )
...
function DropdownMenuCheckboxItem({
  ...
  return /* @__PURE__ */ jsxs4(
    DropdownMenuPrimitive.CheckboxItem,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx9("span", { className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center", children: /* @__PURE__ */ jsx9(DropdownMenuPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx9(CheckIcon2, { className: "size-4" }) }) }),
        children
      ]
    }
  );
...
function DropdownMenuRadioItem({
  ...
  return /* @__PURE__ */ jsxs4(
    DropdownMenuPrimitive.RadioItem,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx9("span", { className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center", children: /* @__PURE__ */ jsx9(DropdownMenuPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx9(CircleIcon, { className: "size-2 fill-current" }) }) }),
        children
      ]
    }
  );
...
function DropdownMenuSubTrigger({
  ...
  return /* @__PURE__ */ jsxs4(
    DropdownMenuPrimitive.SubTrigger,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx9(ChevronRightIcon, { className: "ml-auto size-4" })
      ]
    }
  );
}
...
function InputOTPSlot({
  ...
  return /* @__PURE__ */ jsxs5(
    "div",
    {
      ...
      children: [
        char,
        hasFakeCaret && /* @__PURE__ */ jsx13("div", { className: "pointer-events-none absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsx13("div", { className: "animate-caret-blink bg-foreground h-4 w-px duration-1000" }) })
      ]
    }
  );
}
function InputOTPSeparator({ ...props }) {
  return /* @__PURE__ */ jsx13("div", { "data-slot": "input-otp-separator", role: "separator", ...props, children: /* @__PURE__ */ jsx13(MinusIcon, {}) });
}
...
function SelectGroup({
  ...
  return /* @__PURE__ */ jsx14(SelectPrimitive.Group, { "data-slot": "select-group", ...props });
}
...
function SelectContent({
  ...
  return /* @__PURE__ */ jsx14(SelectPrimitive.Portal, { children: /* @__PURE__ */ jsxs6(
...
function SelectItem({
  ...
  return /* @__PURE__ */ jsxs6(
    SelectPrimitive.Item,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx14("span", { className: "absolute right-2 flex size-3.5 items-center justify-center", children: /* @__PURE__ */ jsx14(SelectPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx14(CheckIcon3, { className: "size-4" }) }) }),
...
var DefaultLink = ({ href, className, children }) => /* @__PURE__ */ jsx18("a", { className, href, children });
...
var AuthUIContext = createContext2(
  {}
);
var AuthUIProvider = ({
  children,
  ...
  const credentials = useMemo(() => {
    ...
    return {
      ...
      forgotPassword: ((credentialsProp == null ? void 0 : credentialsProp.forgotPassword) || forgotPassword) ?? true,
  ...
  return /* @__PURE__ */ jsxs7(
    AuthUIContext.Provider,
    {
      ...
      children: [
        sessionData && (hooks.useActiveOrganization === authClient.useActiveOrganization || hooks.useListOrganizations === authClient.useListOrganizations) && /* @__PURE__ */ jsx18(OrganizationRefetcher, {}),
        (captcha == null ? void 0 : captcha.provider) === "google-recaptcha-v3" ? /* @__PURE__ */ jsx18(RecaptchaV3, { children }) : children
      ]
    }
  );
};
var OrganizationRefetcher = () => {
  const { hooks } = useContext4(AuthUIContext);
  const { data: sessionData } = hooks.useSession();
...
function useAuthData({
  ...
  var _a;
  const { authClient, toast: toast2, localization } = useContext5(AuthUIContext);
  ...
  const previousUserId = useRef2(void 0);
