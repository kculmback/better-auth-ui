...
import { a as AuthLocalization, b as Avatar, C as Card, P as PasswordValidation, I as Input, D as Dialog, B as Button, F as FieldType } from './auth-ui-provider-BrAd4hcX.cjs';
export { e as AppleIcon, o as AuthUIContext, n as AuthUIContextType, p as AuthUIProvider, A as AuthUIProviderProps, t as Components, f as DiscordIcon, g as DropboxIcon, h as FacebookIcon, G as GitHubIcon, i as GitLabIcon, j as GoogleIcon, K as KickIcon, L as LinkedInIcon, M as MicrosoftIcon, q as Provider, d as ProviderIcon, c as ProviderIconProps, R as RedditIcon, k as RobloxIcon, S as SpotifyIcon, T as TikTokIcon, l as TwitchIcon, V as VKIcon, X as XIcon, Z as ZoomIcon, m as authLocalization, r as defaultComponents, s as socialProviders } from './auth-ui-provider-BrAd4hcX.cjs';
